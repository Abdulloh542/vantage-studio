...
export function SolumServices() {
  return (
    <section id="services" className="w-full bg-[#0A0A0A] text-white py-16 sm:py-24 lg:py-32 select-none">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 md:px-12">
        ...
        {/* ========================================================= */}
        {/* 2) MINIMALISTIC FULL-WIDTH CINEMATIC CARDS (77 RENDER STYLE) */}
        {/* ========================================================= */}
